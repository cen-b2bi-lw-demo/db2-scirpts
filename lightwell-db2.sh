...
db2 -S ${DB_SERVER_HOST},${DB_PORT} -d ${DB_NAME} -U ${DB_USER} -P ${DB_PASSWORD} -i DB2-PORTAL.sql
db2 -S ${DB_SERVER_HOST},${DB_PORT} -d ${DB_NAME} -U ${DB_USER} -P ${DB_PASSWORD} -i DB2-FW.sql
db2 -S ${DB_SERVER_HOST},${DB_PORT} -d ${DB_NAME} -U ${DB_USER} -P ${DB_PASSWORD} -i Portal-Seed.sql
db2 -S ${DB_SERVER_HOST},${DB_PORT} -d ${DB_NAME} -U ${DB_USER} -P ${DB_PASSWORD} -i FW-Seed.sql